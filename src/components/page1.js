        ...
        <div className='div2'>
            <div className='citydeg d-flex justify-content-between align-items-center'>
                ...
                <div>
                    ...
                    {propsData.main ? <p style={{textAlign:"center"}}>High/Low : {Math.round(propsData.main.temp_max-273.15)}&#730;C/{Math.round(propsData.main.temp_min-273.15)}&#730;C</p> : null}
                </div>
            </div>
            <div className='dayhwp'>
